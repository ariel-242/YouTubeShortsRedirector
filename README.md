...
1. **Build from Source:** Clone the repo and open `YouTubeShortsRedirector` in Android Studio.
2. **Install APK:** Build and install on your device.
3. **Enable Accessibility Service:** Follow on-screen instructions in the app.

### Chrome Extension

1. **Load Extension:** Go to `chrome://extensions`, enable Developer Mode, and load the `youtube-shorts-redirector` directory.
